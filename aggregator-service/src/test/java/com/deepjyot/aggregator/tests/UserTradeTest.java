...
public class UserTradeTest {
    ...
    public void userInformationTest(){
        ...
        Assertions.assertEquals("integration-tests", user.getName());
    ...
    public void tradeTest(){
         var tradeRequest = StockTradeRequest.newBuilder().setUserId(1).setPrice(10).setTicker(Ticker.AMAZON).setAction(TradeAction.BUY).setQuantity(2).build() ;
